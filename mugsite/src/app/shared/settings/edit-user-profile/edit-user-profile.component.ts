import { Component, OnInit, Output, OnDestroy, Input, OnChanges, SimpleChanges } from '@angular/core';
...
export class EditUserProfileComponent implements OnInit, OnDestroy, OnChanges {
